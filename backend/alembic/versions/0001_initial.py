...
def upgrade() -> None:
    ...
    # orders (com unique user_id+order_date)
    op.create_table(
        "orders",
        sa.Column("id", sa.Integer, primary_key=True),
        ...
        sa.ForeignKeyConstraint(["product_id"], ["products.id"], name="fk_orders_product_id_products", ondelete="RESTRICT"),
